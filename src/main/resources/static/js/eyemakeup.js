...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyFilters() {
        ...
        cards.forEach(card => {
           ...
           if (brands.length && !brands.includes(card.dataset.brand.toLowerCase())) {
                show = false;
            }
            ...
            if (prices.length) {
                ...
                prices.forEach(range => {
                    ...
                    if (range === "0-500" && price < 500) match = true;
                    if (range === "500-1000" && price >= 500 && price <= 1000) match = true;
                    if (range === "1000-2000" && price > 1000 && price <= 2000) match = true;
                    if (range === "2000-3000" && price > 2000 && price <= 3000) match = true;
                    if (range === "3000+" && price > 3000) match = true;
                });
